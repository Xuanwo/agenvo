#!/usr/bin/env python3
"""Stage and optionally pack npm packages for agenvo."""
...
MAIN_PACKAGE_NAME = "agenvo"

PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "agenvo-linux-x64": {
        "npm_name": "agenvo-linux-x64",
        "npm_tag": "linux-x64",
...
PACKAGE_EXPANSIONS: dict[str, list[str]] = {
    "agenvo": ["agenvo", *PLATFORM_PACKAGES],
}

PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    "agenvo": [],
    "agenvo-linux-x64": ["agenvo"],
    "agenvo-linux-arm64": ["agenvo"],
    "agenvo-darwin-x64": ["agenvo"],
    "agenvo-darwin-arm64": ["agenvo"],
    "agenvo-win32-x64": ["agenvo"],
    "agenvo-win32-arm64": ["agenvo"],
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage agenvo npm packages.")
    parser.add_argument(
        "--package",
...
def prepare_staging_dir(staging_dir: Path | None) -> tuple[Path, bool]:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="agenvo-npm-stage-"))
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "agenvo":
        ...
        shutil.copy2(NPM_ROOT / "bin" / "agenvo.js", bin_dir / "agenvo.js")
        ...
        package_json["optionalDependencies"] = {
            ...
            for platform_package in PACKAGE_EXPANSIONS["agenvo"]
            if platform_package != "agenvo"
        }
...
def run_npm_pack(staging_dir: Path, output_path: Path) -> Path:
    ...
    with tempfile.TemporaryDirectory(prefix="agenvo-npm-pack-") as pack_dir_str:
